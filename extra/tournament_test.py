...
def testDeleteMatchesFromTournament(name):
    deleteMatchesFromTournament(name)
    print "\tMatches from tournament {} successfully deleted".format(name)

def testDeleteAllPlayers():
    deletePlayers()
    print "Player records can be deleted."

def testDeregisterPlayersFromTournament():
    return
...
def testStandingsBeforeMatches():
    ...
    if matches1 != 0 or matches2 != 0 or wins1 != 0 or wins2 != 0 or points1 != 0 or points2 != 0:
        raise ValueError(
            "Newly registered players should have no matches, points, or wins.")
...
def testPairings():
    ...
    registerPlayer("Player 5")
    registerPlayer("Player 6")
    registerPlayer("Player 7")
    registerPlayer("PLayer 8")
    standings = playerStandings()
...
if __name__ == '__main__':
    ...
    print "No tests as of right now"
